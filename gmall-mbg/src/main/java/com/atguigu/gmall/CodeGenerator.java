...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("H:\\java_project\\gmall_02\\gmall-parent\\gmall-mbg" + "/src/main/java");
        gc.setAuthor("Lzh");
        ...
        dsc.setUrl("jdbc:mysql://192.168.198.3:3306/gmall_" + moduleName + "?useUnicode=true&useSSL=false&characterEncoding=utf8");
